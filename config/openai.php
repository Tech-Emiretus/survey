...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may specify the default model to use for OpenAI requests. This
    | is used when no specific model is provided in the request. You can set
    | this to any valid OpenAI model, such as "gpt-3.5-turbo" or "gpt-4".
    */
